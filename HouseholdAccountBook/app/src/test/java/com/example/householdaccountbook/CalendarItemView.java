...
public class CalendarItemView extends ConstraintLayout {
    ...
    public static float minCircleScale = 0.75f;
    ...
    private int itemSize = CalendarItemView.minSize;
    ...
    public void setAppearance(int itemSize, float circleScale, int textColor, int circleColor, int strokeColor) {
        setAppearance(itemSize, circleScale);
        // 色付け
    ...
    public void setAppearance(int itemSize, float circleScale) {
