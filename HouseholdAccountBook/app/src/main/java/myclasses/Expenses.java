...
public class Expenses extends BOP {
    ...
    public Expenses(Integer id, Calendar date, int amount, String memo, int categoryId, int paymentMethodId, Calendar paymentDate) {
        super(id, date, amount, memo, categoryId);
        this.paymentMethodId = paymentMethodId;
        this.paymentDate = paymentDate;
        this.isSameDay = MyStdlib.isSameDay(this.getDate(), this.paymentDate);
    }
    public static ContentValues makeContentValues(int _year, int _month, int _day, int _amount, String _memo, int _categoryId, int _paymentMethodId, int pYear, int pMonth, int pDay) {
        ...
        values.put(MyDbContract.ExpensesEntry.COLUMN_CATEGORY_ID, _categoryId);
