...
public class MoneyMovement extends BOP {
    ...
    public ContentValues getContentValues() {
        ...
        values.put(MyDbContract.MoneyMovementsEntry.COLUMN_FROM_WALLET_ID, this.getFromWalletId());
        values.put(MyDbContract.MoneyMovementsEntry.COLUMN_TO_WALLET_ID, this.getToWalletId());
        return values;
    }
}
